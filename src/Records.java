...
public class Records {
    ...
    public DynamicArray handsRecord(BufferedReader bufferedReader, DynamicArray dynamicArray, String jobClass) throws IOException {
    ...
    public DynamicArray fileRecord(BufferedReader bufferedReader, DynamicArray dynamicArray, String jobClass) throws IOException {
        //BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(System.in));
        String path;
        Integer flag = 0;
